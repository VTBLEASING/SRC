CREATE OR REPLACE PROCEDURE DM.p_DM_NIL_CALC_KIS_SINGLE_mv (
                 ...
                 Flow_Cur as(                   
                            ...
                            UNION ALL
                              select 
                                    ...
                                    0 Flow_S_cur,
                                    null ex_rate 
                              from Contr, (select add_months(p_REPORT_DT, - level + 1) as report_dates from dual connect by level < 1000) b where b.report_dates >= to_date('01.01.2014', 'dd.mm.yyyy')
                 /*           UNION ALL
                              select * 
