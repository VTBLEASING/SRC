CREATE OR REPLACE PROCEDURE DM.p_DM_NIL_CALC_KIS_SINGLE_TEST (
...
BEGIN
    dm.u_log(p_proc => 'DM.p_DM_NIL_CALC_KIS_SINGLE',
           p_step => 'INPUT PARAMS',
...
--      THEN 0
  ...
  ELSE (round (a.NIL_KA_KB * (100 / (100 + b.contract_vat_rate*100)), 2) - ROUND (a.UNDERPAY_LEAS * (100 / (100 + b.contract_vat_rate*100)), 2))
