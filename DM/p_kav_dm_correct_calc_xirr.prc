...
insert into TEMP_CORR_Supply_eq                                         
              with                Supply_eq as (select l_key as unpaid_l_key from dm_xirr_flow_orig   ----- 26102015 Составление списка контрактов с оплаченной поставкой
...
commit;
insert into dm_xirr
select distinct p_contract_key, nvl(f_xirr_calc(p_contract_key, p_REPORT_DT), -1) as xirr, p_REPORT_DT as odttm, branch_key, 'Основной КИС' as snapshot_cd, flag as err_flag 
