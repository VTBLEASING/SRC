CREATE OR REPLACE PROCEDURE DM.p_DM_NIL_CALC_KIS_SINGLE_mv_c (
...
-- Добавление потока по цессии из старых договоров        
 ...
 /*                                   union all
                     ...
                     UNDERPAY_L as (
                                  ...
                                  dnil as (select a.dnil_amt + b.CORRECT_AMT as new_dnil_amt from dm.dm_repayment_schedule a, nil_corrects b 
