CREATE OR REPLACE PROCEDURE DM."P_DM_WORK_STATUSES_DAILY" (P_REPORT_DT in date)
IS
BEGIN
...
delete from DM.DM_WORK_STATUSES_DAILY where REPORT_DT = p_REPORT_DT;


insert into DM_WORK_STATUSES_DAILY (REPORT_DT,CONTRACT_KEY,STATUS_1C_DESC,CONTRACT_STATUS_KEY,SUBJECT_STATUS_KEY,STATE_STATUS_KEY,INSERT_DT)
select 
        report_dt, 
        contract_key,
        status_1c_desc,
