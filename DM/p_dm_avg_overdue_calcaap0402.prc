CREATE OR REPLACE PROCEDURE DM.p_DM_AVG_OVERDUE_CALCAAP0402 (
    p_REPORT_DT in date,
...
/* Процедура рассчитывает среднюю просроченную задолженность и заполняет промежуточную витрину DM_AVG_OVERDUE_AMT_AAP0402 
...
BEGIN
    delete from DM_AVG_OVERDUE_AMT_AAP0402 
    ...
    insert into DM_AVG_OVERDUE_AMT_AAP0402 (
                                      contract_id, 
                                      avg_overdue_amt, 
                                      ODDTM,
                                      branch_key,
                       ...
                       */               
                       overdue as (    
                           ...
                           select contract_id, 
                            ...
                            group by contract_id, branch_key 
                       ...
                       overdue_avg as
                        (select contract_id, 
                          ...
                          select contract_id, sum (avg_overdue_amt), lastday, branch_key, snapshot_cd
                          from overdue_avg
                         
                          group by contract_id, branch_key, lastday, snapshot_cd;
