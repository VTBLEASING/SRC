CREATE OR REPLACE PROCEDURE DM."P_DM_OL_FLOW_KIS_SINGLE" (
...
BEGIN
  ...
  dm.u_log(p_proc => 'p_DM_OL_FLOW_KIS_SINGLE',
   ...
   insert into dm_ol_flow_orig
        (l_key, branch_key, cbc_desc, pay_dt, pay_amt_cur, pay_amt, tp, cur1, cur2, cur3, pay_amt_cur_supply, snapshot_dt, snapshot_cd, l_key_dop, s_key)
    (
   select * from (
           with
