create or replace force view dm.v$ol_supply_sum as
select "CONTRACT_KEY","S_KEY","CUR","BRANCH_KEY","SNAPSHOT_CD","SNAPSHOT_DT","S_AMT","S_AMT_F","S_AMT_F_R"
from (
                select
...
--                  ,rt3.EXCHANGE_RATE  s_ex_rate
                ...
                where TP Like 'Supply%' -- and CBC_DESC = '??.3.1'
                group by
                  --S.snapshot_dt + 1,
                  S.L_KEY,
                  S.S_KEY,
