CREATE OR REPLACE FORCE VIEW DM.V_DM_OL_METRIC AS
with tt as
(
        SELECT
...
--  cgp.insert_dt,
 ...
 -- CONTR.SNAPSHOT_DT + 1 AS REP_DT,
  sysdate insert_dt,
  dm_cl.activity_type_key activity_type_key,
    ...
    LEFT JOIN DM.DM_CLIENTS dm_CL
        ON    co.CLIENT_KEY = dm_CL.CLIENT_KEY
         ...
         left JOIN dwh.business_categories bus_cat
            ...
            and dm_cl.SNAPSHOT_DT between bus_cat.BEGIN_DT and bus_cat.END_DT
