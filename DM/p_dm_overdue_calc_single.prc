CREATE OR REPLACE PROCEDURE DM.p_DM_OVERDUE_CALC_SINGLE(
...
BEGIN
  dm.u_log(p_proc => 'DM.p_DM_OVERDUE_CALC_SINGLE',
           p_step => 'INPUT PARAMS',
              ...
              Flow_plan_fact as
                    (
                     SELECT Contr.L_KEY,
                            ...
                            Contr.base_currency,
                            Contr.contract_vat_rate -- Add By Zanozin
                     ...
                     SELECT Contr.L_KEY,
                            ...
                            fact_pp.CURRENCY_KEY CUR2,
                            Contr.base_currency
                            ,Contr.contract_vat_rate -- Add By Zanozin 19/06/2017
                     from (select distinct 
                                        L_KEY,
                                        branch_key,
                                        L_CUR,
          ...
          FLOW as (
                select L_KEY,
                      ...
                      -- vat.vat_rate,
                       f.contract_vat_rate
                from flow_cur f
--                inner join dwh.contracts c1 on   c1.contract_key=f.L_KEY--- Add by Zanozin 
...
--                    and c1.valid_to_dttm = to_date ('01.01.2400', 'dd.mm.yyyy')
                group by l_key, f.branch_key,f.contract_vat_rate--, vat.vat_rate --,c1.contract_vat_rate
                )
